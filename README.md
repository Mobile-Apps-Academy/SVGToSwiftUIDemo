...
Demo of how to convert SVG code to SwiftUI code.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/SVGToSwiftUIDemo.git
   ```
### Usage

1. URL - https://svg-to-swiftui.quassum.com/
